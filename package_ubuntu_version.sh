...
sudo mkdir -p $TMP/opt/Strudel/icons/
sudo cp IconPngs/MASSIVElogoTransparent144x144.png  $TMP/opt/Strudel/icons/MASSIVElogoTransparent144x144.png
sudo cp Strudel.desktop $TMP/opt/Strudel/"Strudel.desktop"
